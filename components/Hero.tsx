    ...
    return (
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden px-6 py-20">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <div className="absolute top-20 left-10 w-64 h-64 bg-neon-purple/20 rounded-full blur-3xl animate-float" />
                <div className="absolute bottom-20 right-10 w-96 h-96 bg-neon-blue/20 rounded-full blur-3xl animate-float" style={{ animationDelay: '2s' }} />
                    ...
                    <div className="space-y-6 animate-slide-up">
                        ...
                        <div className="flex gap-4 pt-4">
                            ...
                            <a
                                href={profile.resume}
                                download
                                className="px-8 py-3 glass-panel border border-white/10 text-white font-semibold rounded-full hover:bg-white/5 transition-colors flex items-center gap-2"
                            >
                                Download CV
